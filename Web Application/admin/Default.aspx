	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Health Monitor <br /></h3>
                                    <p>~</p>
                                </div>
                            </div>
                            <%--<div>
                                <div>
                                    <h3>Welcome to SPKV Takari
                                    </h3>
                                    <p></p>
                                </div>
                            </div>
        ...
        <div class="body">
            ...
            <asp:Button ID="btnHide" runat="server" Text="Close" />
                                        ...
                                        <div class="form-group">
                                            <input required="" name="username" type="text" class="form-control" placeholder="Username" style="margin-left:0px" id="exampleInputEmail1">
                                        </div>
                                        <div class="form-group">
                                            <input required="" name="password" type="password" class="form-control" placeholder="Password" style="margin-left:0px">
                                        </div>
                                        ...
                                        <br />
                                        *Note To Login Use Username = admin and Password = admin
                                    </form>
                                </div>
